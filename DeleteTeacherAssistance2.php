<html>
    <head><title>Delete Teacher Assistance</title></head>
    <h1>Delete Teacher Assistance</h1>
    <style>
.navbar {
    overflow: hidden;
 ...
 <div class="navbar">
    ...
    <body>
        <form method="post" action="DeleteTeacherAssistance.php">
            <label>Teacher AssistanceID: </label>
                <input type="text" name="taid"><br>
...
$sql = "DELETE FROM teachingassistance WHERE taID=$taid";
